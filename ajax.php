...
if (
    ...
    mysqli_stmt_bind_param($stmt, 'issiii', $_POST['edit_country_id'], $_POST['edit_nominal'], $_POST['edit_catalog_number'], $_POST['edit_alloy_id'], $_POST['edit_year'], $_GET['edit']);
    ...
    $sql = "SELECT * FROM monetki INNER JOIN panstwa ON monetki.country_id=panstwa.country_id INNER JOIN stopy ON monetki.alloy_id=stopy.alloy_id ORDER BY monetki.id";
